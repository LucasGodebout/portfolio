...
try {
    ...
    $mail->Username   = 'lucasgodeboutcontact@gmail.com'; //SMTP username (email utilisé pour envoyer le formulaire. Il doit etre celui de la validation en deux étapes et de création de mot de passe application !)
    $mail->Password   = 'qerx lrvq mbhr wfow'; // SMTP password (regarder la vidéo pour voir comment avoir ce mot de passe)
