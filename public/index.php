...
<body>
    ...
    <main id="main-content">
        <div id="front-page">
            <a class="logo-container" id="logo" onclick="openCVPage()">
                <img class="logo" src="./assets/images/icons/lurk.png" alt="Lucas Godebout Logo">               
            </a>
            <div id="menu-icons">
                <div id="menu">
                        ...
                        <form class="email-form" id="email-form" method="POST" action="javascript:void(0);">
                            <div class="email-form-grid">
                                ...
                                <div class="email-form-right">
                                    ...
                                    <input class="email-input" type="type" id="email" name="email" required>                                    
        ...
        <!-- Système de la page CV -->
        <section class="cv-overlay" id="cv-overlay">
            <div class="cv-page" id="cv-page">
                <div class="cv-header"> 
                    <button class="cv-close" id="cv-close">&times;</button>
                    <h2 class="cv-title">Revenir au menu</h2>
                </div>
                <div class="cv-logo-container" id="cv-logo-container">
                    <div class="logo-container" id="cv-logo">
                        <img class="logo" src="./assets/images/icons/lurk.png" alt="Lucas Godebout Logo">
                    </div>
                </div>
                <div class="cv-content" id="cv-content">
                    <div class="cv-content-header">
                        <h1 class="cv-name">Lucas Godebout</h1>
                        <p class="cv-tagline">Développeur Web en recherche d'alternance (Bac+3)</p>
                    </div>
                    <div class="cv-grid">
                        <aside class="cv-column">
                            <div class="cv-avatar-container">
                                <img src="./assets/images/icons/Lucas.jpg" alt="Lucas Godebout" class="cv-avatar">
                            </div>
                            <section class="cv-box">
                                <h2 class="box-title label-blue">À propos de moi</h2>
                                <p class="box-text">
                                    Je suis à la recherche d'une opportunité d'alternance dans le développement web pour l'année prochaine (rythme de 2 semaines en entreprise / 1 semaine en cours) dès Septembre.
                                </p>
                            </section>
                            <section class="cv-box">
                                <h2 class="box-title label-orange">Compétences</h2>
                                <div class="badge-container">
                                    ...
                                    <span class="badge">Suite Adobe</span>
                                    <span class="badge">Figma</span>
                                    <span class="badge">C/C++</span>
                                </div>
                            </section>
                            <section class="cv-box">
                                <h2 class="box-title label-blue">Contact & Infos</h2>
                                <div class="info-item">
                                    <span class="info-label">Site :</span>
                                    <span class="info-val">https://lucasgdbt.fr</span>
                                </div>
                                <div class="info-item" style="margin-top: 8px;">
                                    <span class="box-text">📍 Baugé, 49150</span>
                                </div>
                                <div class="info-item">
                                    <span class="box-text">🚗 Permis B</span>
                                </div>
                            </section>
                        </aside>
                        <main class="cv-column">
                            <section class="cv-box">
                                <h2 class="box-title label-blue">Formations</h2>
                                <div class="timeline-item">
                                    <span class="date">2024 - 2026</span>
                                    <h3>Bachelor Développeur Web</h3>
                                    <p>My Digital School - Angers</p>
                                </div>
                                <div class="timeline-item">
                                    <span class="date">2023 - 2024</span>
                                    <h3>Bachelor Learn It</h3>
                                    <p>Open Campus - Angers</p>
                                </div>
                                <div class="timeline-item">
                                    <span class="date">2023</span>
                                    <h3>Baccalauréat STI2D SIN</h3>
                                </div>
                            </section>
                            <section class="cv-box">
                                <h2 class="box-title label-orange">Profil personnel</h2>
                                <div style="margin-bottom: 20px;">
                                    <h3 class="sub-title">Langues</h3>
                                    <p class="box-text">Anglais B2 • Espagnol B1</p>
                                </div>
                                <div style="margin-bottom: 20px;">
                                    <h3 class="sub-title">Qualités</h3>
                                    <p class="box-text">Rigoureux • Esprit d'équipe • À l'écoute • Résolution de problèmes</p>
                                </div>
                                <div>
                                    <h3 class="sub-title">Passions</h3>
                                    <p class="box-text">Culture japonaise (Animation, livres, musiques) • Esport</p>
                                </div>
                            </section>
                        </main>
                    </div>
